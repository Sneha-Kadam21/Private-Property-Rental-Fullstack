...
function ListingPage3() {
  ...
  return (
    ...
    <div className='w-[50px] h-[50px] bg-[red] cursor-pointer absolute 
            ...
            onClick={()=>navigate("/listingpage2")}><FaArrowLeft 
            ...
            <div className='w-[95%] h-[400px] flex items-center justify-center flex-col md:w-[80%] md:flex-row '>
             ...
             <div className='w-[95%] flex items-start justify-start text-[18px] md:w-[80%] md:text-[25px]'>
              ...
              <div className='w-[95%] h-[50px] flex items-center justify-start px-[100px]'>
                <button className='px-[50px] py-[10px] bg-[red] text-[white] text-[18px] md:px-[100px] rounded-lg ' onClick={handleAddListing} disabled={adding}>
